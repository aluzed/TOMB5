# RE-249 — lara-combat-parser-artifact-reconciliation

Status: Done

## Goal

Advance `lara-combat-parser-artifact-reconciliation` within the lara-combat epic using metadata-only proof artifacts.

## Scope

- scope: `parser-artifact rows excluded from function scope`
- candidates: `3`
