# RE-245 — lara-combat-proof-first-audit

Status: Done

## Goal

Advance `lara-combat-proof-first-audit` within the lara-combat epic using metadata-only proof artifacts.

## Scope

- scope: `all lara-combat candidates plus parser-artifact suppression`
- candidates: `10`
