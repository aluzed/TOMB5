# RE-222 — traps-switches-doors-proof-first-audit

Status: Done

## Goal

Advance `traps-switches-doors-proof-first-audit` within the traps-switches-doors epic using metadata-only proof artifacts.

## Scope

- scope: `all traps-switches-doors candidates`
- candidates: `20`
