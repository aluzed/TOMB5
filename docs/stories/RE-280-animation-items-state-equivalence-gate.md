# RE-280 — animation-items-state-equivalence-gate

Status: Done

## Goal

Advance `animation-items-state-equivalence-gate` for `animation-items` without source or marker changes.
...
- Scope: `animation item state/equivalence proof`
- Candidate count: `31`
- Artifact: `docs/reverse/generated/re281-animation-items-source-patch-gates.csv`
