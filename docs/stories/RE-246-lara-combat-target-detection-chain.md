# RE-246 — lara-combat-target-detection-chain

Status: Done

## Goal

Advance `lara-combat-target-detection-chain` within the lara-combat epic using metadata-only proof artifacts.

## Scope

- scope: `target-detection candidates`
- candidates: `2`
