# RE-108 — Pickup search closure or handoff

Status: Done

## Goal

Advance `pickup-search-control` within `gameflow-runtime-control` using metadata-only evidence for RE-108.
...
- handoff target: TBD object-runtime-control-exhausted

## Readiness decision

- decision: `object-runtime-control-exhausted`
