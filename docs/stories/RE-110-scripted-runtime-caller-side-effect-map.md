# RE-110 — Scripted runtime caller side-effect map

Status: Done

## Goal

Advance `scripted-runtime-control` within `gameflow-runtime-control` using metadata-only evidence for RE-110.
...
- decision: `caller-side-effect-map-published`
