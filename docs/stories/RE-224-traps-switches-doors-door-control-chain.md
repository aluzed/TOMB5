# RE-224 — traps-switches-doors-door-control-chain

Status: Done

## Goal

Advance `traps-switches-doors-door-control-chain` within the traps-switches-doors epic using metadata-only proof artifacts.

## Scope

- scope: `door-control candidates`
- candidates: `4`
