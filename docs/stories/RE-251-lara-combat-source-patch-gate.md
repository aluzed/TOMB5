# RE-251 — lara-combat-source-patch-gate

Status: Done

## Goal

Advance `lara-combat-source-patch-gate` within the lara-combat epic using metadata-only proof artifacts.

## Scope

- scope: `ready lara-combat rows`
- candidates: `7`
