"""Produce the fail-closed, metadata-only RE-612 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re611-ghidra-second-window-rank-85-narrow-export-handoff.csv'
PREFIX = 're612-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-611', 'topic': 'ghidra-second-window-rank-85-narrow-export',
    'upstream_handoff': 'RE-610', 'selected_candidate_id': '259084955c25',
    'selected_rank': '85', 'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-612', topic='mapped-caller-callee-bridge-readiness-gate', upstream_handoff='RE-611',
        selected_candidate_id='259084955c25', selected_rank='85',
        ...
        next_ticket='RE-613', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re612-mapped-caller-callee-bridge-readiness-gate.md': '# RE-612 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-612-mapped-caller-callee-bridge-readiness-gate.md': '# RE-612 readiness gate\n\n## Progress tracker\n\n- [x] RE-611 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-613 selected; not executed.\n',
    }
