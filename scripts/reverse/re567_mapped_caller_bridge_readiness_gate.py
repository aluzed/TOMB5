"""Fail-closed metadata-only readiness gate for RE-567."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re566-ghidra-second-window-rank-70-narrow-export-handoff.csv'
PREFIX = 're567-mapped-caller-bridge-readiness-gate'
...
def build(repo):
    ...
    expected = {
        ...
        'upstream_handoff': 'RE-565', 'selected_candidate_id': 'bcfd4d0060be',
    ...
    row = dict(
        story_id='RE-567', topic='mapped-caller-bridge-readiness-gate', upstream_handoff='RE-566',
        selected_candidate_id='bcfd4d0060be', selected_rank='70',
        ...
        next_ticket='RE-568', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re567-mapped-caller-bridge-readiness-gate.md': '# RE-567 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-567-mapped-caller-bridge-readiness-gate.md': '# RE-567 readiness gate\n\n## Progress tracker\n\n- [x] RE-566 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-568 selected; not executed.\n',
    }
