"""Fail-closed metadata-only RE-644 rank-96 narrow export."""
import csv
import sys
...
from scripts.reverse import re641_ghidra_second_window_rank_95_narrow_export as base

BAD, FIELDS, UPFIELDS = base.BAD, base.FIELDS, base.UPFIELDS
UPSTREAM = 'docs/reverse/generated/re643-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're644-ghidra-second-window-rank-96-narrow-export'
EXPECTED = {
    'story_id': 'RE-643', 'topic': 'ghidra-second-window-next-candidate-selection',
    'upstream_handoff': 'RE-642', 'closed_candidate_id': '96429b1f52ed', 'selected_rank': '96',
    'selected_candidate_id': '7129784944ab', 'selected_bridge_class': 'mapped-caller-bridge',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-644',
    'next_topic': 'ghidra-second-window-rank-96-narrow-export',
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re644-ghidra-second-window-rank-96-narrow-export.md': '# RE-644 rank-96 narrow export\n\nThe selected candidate is filtered metadata only; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-644-ghidra-second-window-rank-96-narrow-export.md': '# RE-644 rank-96 narrow export\n\n## Progress tracker\n\n- [x] RE-643 handoff validated.\n- [x] Rank-96 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Production and code work remain blocked.\n- [x] RE-645 selected; not executed.\n',
    }
