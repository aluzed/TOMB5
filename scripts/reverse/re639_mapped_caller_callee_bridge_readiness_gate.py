"""Produce the fail-closed, metadata-only RE-639 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re638-ghidra-second-window-rank-94-narrow-export-handoff.csv'
PREFIX = 're639-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-638', 'topic': 'ghidra-second-window-rank-94-narrow-export',
    'upstream_handoff': 'RE-637', 'selected_candidate_id': 'a4687ba1ab10',
    'selected_rank': '94', 'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re639-mapped-caller-callee-bridge-readiness-gate.md': '# RE-639 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-639-mapped-caller-callee-bridge-readiness-gate.md': '# RE-639 readiness gate\n\n## Progress tracker\n\n- [x] RE-638 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-640 selected; not executed.\n',
    }
