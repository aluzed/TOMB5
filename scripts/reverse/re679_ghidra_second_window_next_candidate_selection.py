"""Fail-closed metadata-only RE-679 candidate selection."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re678-mapped-caller-callee-bridge-readiness-gate-handoff.csv'
PREFIX = 're679-ghidra-second-window-next-candidate-selection'
EXPECTED = {
    'story_id': 'RE-678', 'topic': 'mapped-caller-callee-bridge-readiness-gate',
    'upstream_handoff': 'RE-677', 'selected_candidate_id': 'e16b24e1fe2c', 'selected_rank': '107',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-679',
...
OUTPUT = {
    ...
    'upstream_handoff': 'RE-678', 'closed_candidate_id': 'e16b24e1fe2c',
    'selected_rank': '108', 'selected_candidate_id': 'eb8e14a9b966',
    ...
    'next_ticket': 'RE-680', 'next_topic': 'ghidra-second-window-rank-108-narrow-export',
    'metadata_work_readiness': 'ready', 'code_change_readiness': 'blocked',
...
def build(repo):
    ...
    if actual != ('eb8e14a9b966', 'mapped-caller-callee-bridge', 4, 'no', 'no'):
...
def write(row, repo):
    ...
    for suffix in ('candidates', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re679-ghidra-second-window-next-candidate-selection.md': '# RE-679 selection\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-679-ghidra-second-window-next-candidate-selection.md': '# RE-679 selection\n\n## Progress tracker\n\n- [x] RE-678 handoff validated.\n- [x] Rank-108 candidate selected from the fixed safe ranking.\n- [x] Filtered metadata-only safety retained.\n- [x] Production and code work remain blocked.\n- [x] RE-680 selected; not executed.\n',
    }
