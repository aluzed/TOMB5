"""Produce the fail-closed, metadata-only RE-654 readiness gate."""
import csv
import sys
...
from scripts.reverse import re651_mapped_caller_callee_bridge_readiness_gate as base

BAD, UPFIELDS, FIELDS = base.BAD, base.UPFIELDS, base.FIELDS
UPSTREAM = 'docs/reverse/generated/re653-ghidra-second-window-rank-99-narrow-export-handoff.csv'
PREFIX = 're654-mapped-callee-bridge-readiness-gate'
EXPECTED = {
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re654-mapped-callee-bridge-readiness-gate.md': '# RE-654 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-654-mapped-callee-bridge-readiness-gate.md': '# RE-654 readiness gate\n\n## Progress tracker\n\n- [x] RE-653 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-655 selected; not executed.\n',
    }
