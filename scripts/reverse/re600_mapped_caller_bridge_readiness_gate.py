"""Produce the fail-closed, metadata-only RE-600 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re599-ghidra-second-window-rank-81-narrow-export-handoff.csv'
PREFIX = 're600-mapped-caller-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-599', 'topic': 'ghidra-second-window-rank-81-narrow-export',
    'upstream_handoff': 'RE-598', 'selected_candidate_id': '017bb509d513',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-600', topic='mapped-caller-bridge-readiness-gate', upstream_handoff='RE-599',
        selected_candidate_id='017bb509d513', selected_rank='81',
        ...
        next_ticket='RE-601', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re600-mapped-caller-bridge-readiness-gate.md': '# RE-600 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-600-mapped-caller-bridge-readiness-gate.md': '# RE-600 readiness gate\n\n## Progress tracker\n\n- [x] RE-599 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-601 selected; not executed.\n',
    }
