"""Fail-closed metadata-only readiness gate for RE-582."""
import csv
import sys
...
from scripts.reverse import re579_mapped_caller_bridge_readiness_gate as base
BAD, UPFIELDS, FIELDS = base.BAD, base.UPFIELDS, base.FIELDS
UPSTREAM = 'docs/reverse/generated/re581-ghidra-second-window-rank-75-narrow-export-handoff.csv'
PREFIX = 're582-mapped-caller-bridge-readiness-gate'
...
def write(row,repo):
    ...
    for suffix in ('gate','summary','handoff'):
        ...
        outputs.append(p)
    documents={repo/'docs/reverse/functions/re582-mapped-caller-bridge-readiness-gate.md':'# RE-582 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',repo/'docs/stories/RE-582-mapped-caller-bridge-readiness-gate.md':'# RE-582 readiness gate\n\n## Progress tracker\n\n- [x] RE-581 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-583 selected; not executed.\n'}
