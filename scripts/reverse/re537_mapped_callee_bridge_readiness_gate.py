"""Fail-closed metadata-only readiness gate for RE-537."""
import csv
...
UPSTREAM='docs/reverse/generated/re536-ghidra-second-window-rank-60-narrow-export-handoff.csv';PREFIX='re537-mapped-callee-bridge-readiness-gate'
...
def write(row,repo):
 ...
 for suffix in ('gate','summary','handoff'):
  ...
  outputs.append(path)
 documents={repo/'docs/reverse/functions/re537-mapped-callee-bridge-readiness-gate.md':'# RE-537 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',repo/'docs/stories/RE-537-mapped-callee-bridge-readiness-gate.md':'# RE-537 readiness gate\n\n## Progress tracker\n\n- [x] RE-536 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-538 selected; not executed.\n'}
