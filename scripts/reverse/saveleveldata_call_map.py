...
def _candidate_source_rows(source_rows: tuple[WriteRow, ...]) -> list[tuple[str, str, str, str]]:
    ...
    return [
        ...
        ("17-25", "item position block and optional speed/fallspeed writes", "low", "candidate item save_position branch"),
        ("17-32", "item active/full-save branch variant", "low", "same source rows can compile into several original call regions"),
        ("26-32", "item animation and hitpoint fields", "low", "candidate save_anim/save_hitpoints branch"),
        ("17-32", "item serialization alternate control-flow region", "low", "requires manual MIPS branch audit"),
        ("17-32", "item serialization dense call region", "low", "largest repeated candidate item region"),
        ("29-32", "lara/non-lara anim-number and frame/hitpoint tail", "low", "tail branch candidate"),
        ("17-32", "item serialization second variant", "low", "requires mapping against item/object flags"),
        ("31-32", "frame number / hit points tail", "low", "late item tail candidate"),
        ("17-32", "item serialization final variant", "low", "final original call group before function return"),
    ]
