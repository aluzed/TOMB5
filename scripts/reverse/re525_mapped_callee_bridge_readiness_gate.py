"""Fail-closed metadata-only readiness gate for RE-525."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re524-ghidra-second-window-rank-56-narrow-export-handoff.csv'
PREFIX = 're525-mapped-callee-bridge-readiness-gate'
...
def build(repo):
    ...
    expected = {
        'story_id': 'RE-524',
        'topic': 'ghidra-second-window-rank-56-narrow-export',
        'upstream_handoff': 'RE-523',
        'selected_candidate_id': '9f1d49236ff5',
        'selected_rank': '56',
        ...
        'stop_condition': 'narrow rank-56 export requires readiness gate before proof-domain selection',
    }
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re525-mapped-callee-bridge-readiness-gate.md': '# RE-525 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-525-mapped-callee-bridge-readiness-gate.md': '# RE-525 readiness gate\n\n## Progress tracker\n\n- [x] RE-524 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-526 selected; not executed.\n',
    }
