"""Fail-closed metadata-only RE-629 rank-91 narrow export."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re628-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're629-ghidra-second-window-rank-91-narrow-export'
UPFIELDS = (
...
EXPECTED = {
    ...
    'upstream_handoff': 'RE-627', 'closed_candidate_id': 'a4b0386cc63b', 'selected_rank': '91',
    'selected_candidate_id': 'a9050d9119e9', 'selected_bridge_class': 'mapped-caller-callee-bridge',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-629',
    'next_topic': 'ghidra-second-window-rank-91-narrow-export',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-629', topic='ghidra-second-window-rank-91-narrow-export',
        upstream_handoff='RE-628', selected_candidate_id='a9050d9119e9', selected_rank='91',
        ...
        ready_to_reopen_domain_count='0', source_patch_authorized_count='0',
        selected_domain='none', selected_pivot='none', next_ticket='RE-630',
        next_topic='mapped-caller-callee-bridge-readiness-gate', metadata_work_readiness='ready',
        code_change_readiness='blocked',
        stop_condition='narrow rank-91 export requires readiness gate before proof-domain selection',
    )
    validate(row)
    return row
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re629-ghidra-second-window-rank-91-narrow-export.md': '# RE-629 rank-91 narrow export\n\nThe selected candidate is filtered metadata only; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-629-ghidra-second-window-rank-91-narrow-export.md': '# RE-629 rank-91 narrow export\n\n## Progress tracker\n\n- [x] RE-628 handoff validated.\n- [x] Rank-91 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Production and code work remain blocked.\n- [x] RE-630 selected; not executed.\n',
    }
