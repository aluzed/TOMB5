"""Fail-closed metadata-only RE-611 rank-85 narrow export."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re610-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're611-ghidra-second-window-rank-85-narrow-export'
UPFIELDS = (
...
EXPECTED = {
    'story_id': 'RE-610', 'topic': 'ghidra-second-window-next-candidate-selection',
    'upstream_handoff': 'RE-609', 'closed_candidate_id': '8f58d6e07fc8',
    'selected_rank': '85', 'selected_candidate_id': '259084955c25',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-611',
    'next_topic': 'ghidra-second-window-rank-85-narrow-export',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-611', topic='ghidra-second-window-rank-85-narrow-export',
        upstream_handoff='RE-610', selected_candidate_id='259084955c25', selected_rank='85',
        ...
        ready_to_reopen_domain_count='0', source_patch_authorized_count='0',
        selected_domain='none', selected_pivot='none', next_ticket='RE-612',
        next_topic='mapped-caller-callee-bridge-readiness-gate',
        metadata_work_readiness='ready', code_change_readiness='blocked',
        stop_condition='narrow rank-85 export requires readiness gate before proof-domain selection',
    )
    validate(row)
    return row
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re611-ghidra-second-window-rank-85-narrow-export.md': '# RE-611 rank-85 narrow export\n\nThe selected candidate is filtered metadata only; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-611-ghidra-second-window-rank-85-narrow-export.md': '# RE-611 rank-85 narrow export\n\n## Progress tracker\n\n- [x] RE-610 handoff validated.\n- [x] Rank-85 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Production and code work remain blocked.\n- [x] RE-612 selected; not executed.\n',
    }
