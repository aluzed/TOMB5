"""Produce the fail-closed, metadata-only RE-548 rank-64 narrow export."""
import csv
...
UPSTREAM='docs/reverse/generated/re547-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX='re548-ghidra-second-window-rank-64-narrow-export'
...
def write(row,repo):
    ...
    for suffix in ('contexts','summary','handoff'):
        ...
        out.append(p)
    docs={repo/'docs/reverse/functions/re548-ghidra-second-window-rank-64-narrow-export.md':'# RE-548 rank-64 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n',repo/'docs/stories/RE-548-ghidra-second-window-rank-64-narrow-export.md':'# RE-548 rank-64 narrow export\n\n## Progress tracker\n\n- [x] RE-547 handoff validated.\n- [x] Rank-64 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-549 selected; not executed.\n'}
