"""Produce the fail-closed, metadata-only RE-533 rank-59 narrow export."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re532-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're533-ghidra-second-window-rank-59-narrow-export'
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        with path.open('w', encoding='utf-8', newline='') as handle:
            ...
            writer.writerow(row)
        outputs.append(path)
    documents = {repo / 'docs/reverse/functions/re533-ghidra-second-window-rank-59-narrow-export.md': '# RE-533 rank-59 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n', repo / 'docs/stories/RE-533-ghidra-second-window-rank-59-narrow-export.md': '# RE-533 rank-59 narrow export\n\n## Progress tracker\n\n- [x] RE-532 handoff validated.\n- [x] Rank-59 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-534 selected; not executed.\n'}
