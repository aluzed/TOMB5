"""Fail-closed metadata-only readiness gate for RE-561."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re560-ghidra-second-window-rank-68-narrow-export-handoff.csv'
PREFIX = 're561-mapped-callee-bridge-readiness-gate'
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re561-mapped-callee-bridge-readiness-gate.md': '# RE-561 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-561-mapped-callee-bridge-readiness-gate.md': '# RE-561 readiness gate\n\n## Progress tracker\n\n- [x] RE-560 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-562 selected; not executed.\n',
    }
