"""Produce the fail-closed, metadata-only RE-578 rank-74 narrow export."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re577-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're578-ghidra-second-window-rank-74-narrow-export'
...
def write(row, repo):
    ...
    for suffix in ('contexts','summary','handoff'):
        ...
        outputs.append(p)
    documents={repo/'docs/reverse/functions/re578-ghidra-second-window-rank-74-narrow-export.md':'# RE-578 rank-74 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n',repo/'docs/stories/RE-578-ghidra-second-window-rank-74-narrow-export.md':'# RE-578 rank-74 narrow export\n\n## Progress tracker\n\n- [x] RE-577 handoff validated.\n- [x] Rank-74 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-579 selected; not executed.\n'}
