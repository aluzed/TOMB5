"""Produce the fail-closed, metadata-only RE-594 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re593-ghidra-second-window-rank-79-narrow-export-handoff.csv'
PREFIX = 're594-mapped-caller-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-593', 'topic': 'ghidra-second-window-rank-79-narrow-export',
    'upstream_handoff': 'RE-592', 'selected_candidate_id': '6ba32f9cc1f5',
    'selected_rank': '79', 'selected_subcluster': 'mapped-caller-bridge-readiness-gate',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-594', topic='mapped-caller-bridge-readiness-gate', upstream_handoff='RE-593',
        selected_candidate_id='6ba32f9cc1f5', selected_rank='79',
        ...
        next_ticket='RE-595', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re594-mapped-caller-bridge-readiness-gate.md': '# RE-594 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-594-mapped-caller-bridge-readiness-gate.md': '# RE-594 readiness gate\n\n## Progress tracker\n\n- [x] RE-593 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-595 selected; not executed.\n',
    }
