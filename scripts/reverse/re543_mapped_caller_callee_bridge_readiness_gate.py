"""Fail-closed metadata-only readiness gate for RE-543."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re542-ghidra-second-window-rank-62-narrow-export-handoff.csv'
PREFIX = 're543-mapped-caller-callee-bridge-readiness-gate'
...
def build(repo):
    ...
    row = dict(
        story_id='RE-543', topic='mapped-caller-callee-bridge-readiness-gate',
        upstream_handoff='RE-542', selected_candidate_id='605d53c8fbfb', selected_rank='62',
        ...
        ready_to_reopen_domain_count='0', source_patch_authorized_count='0',
        selected_domain='none', selected_pivot='none', next_ticket='RE-544',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re543-mapped-caller-callee-bridge-readiness-gate.md':
            '# RE-543 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-543-mapped-caller-callee-bridge-readiness-gate.md':
            '# RE-543 readiness gate\n\n## Progress tracker\n\n- [x] RE-542 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-544 selected; not executed.\n',
    }
