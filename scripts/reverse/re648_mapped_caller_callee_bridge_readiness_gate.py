"""Produce the fail-closed, metadata-only RE-648 readiness gate."""
import csv
import sys
...
from scripts.reverse import re645_mapped_caller_bridge_readiness_gate as base

BAD, UPFIELDS, FIELDS = base.BAD, base.UPFIELDS, base.FIELDS
UPSTREAM = 'docs/reverse/generated/re647-ghidra-second-window-rank-97-narrow-export-handoff.csv'
PREFIX = 're648-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re648-mapped-caller-callee-bridge-readiness-gate.md': '# RE-648 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-648-mapped-caller-callee-bridge-readiness-gate.md': '# RE-648 readiness gate\n\n## Progress tracker\n\n- [x] RE-647 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-649 selected; not executed.\n',
    }
