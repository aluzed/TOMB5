"""Produce the fail-closed, metadata-only RE-521 rank-55 narrow export."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re520-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're521-ghidra-second-window-rank-55-narrow-export'
...
def build(repo):
    ...
    expected = {
        ...
        'upstream_handoff': 'RE-519', 'closed_candidate_id': '65e0849a91c0',
    ...
    row = dict(
        story_id='RE-521', topic='ghidra-second-window-rank-55-narrow-export',
        upstream_handoff='RE-520', selected_candidate_id='c126657cee24', selected_rank='55',
        selected_subcluster='mapped-callee-bridge-readiness-gate', source_symbol_context_count='6',
        bridge_class='mapped-callee-bridge', safe_context_status='filtered-metadata-only',
        candidate_level_proof_count='0', ready_to_reopen_domain_count='0',
        source_patch_authorized_count='0', selected_domain='none', selected_pivot='none',
        next_ticket='RE-522', next_topic='mapped-callee-bridge-readiness-gate',
        metadata_work_readiness='ready', code_change_readiness='blocked',
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re521-ghidra-second-window-rank-55-narrow-export.md': '# RE-521 rank-55 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-521-ghidra-second-window-rank-55-narrow-export.md': '# RE-521 rank-55 narrow export\n\n## Progress tracker\n\n- [x] RE-520 handoff validated.\n- [x] Rank-55 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-522 selected; not executed.\n',
    }
