"""Fail-closed metadata-only readiness gate for RE-558."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re557-ghidra-second-window-rank-67-narrow-export-handoff.csv'
PREFIX = 're558-mapped-caller-bridge-readiness-gate'
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {repo / 'docs/reverse/functions/re558-mapped-caller-bridge-readiness-gate.md': '# RE-558 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n', repo / 'docs/stories/RE-558-mapped-caller-bridge-readiness-gate.md': '# RE-558 readiness gate\n\n## Progress tracker\n\n- [x] RE-557 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-559 selected; not executed.\n'}
