"""Fail-closed metadata-only readiness gate for RE-555."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re554-ghidra-second-window-rank-66-narrow-export-handoff.csv'
PREFIX = 're555-mapped-callee-bridge-readiness-gate'
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {repo / 'docs/reverse/functions/re555-mapped-callee-bridge-readiness-gate.md': '# RE-555 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n', repo / 'docs/stories/RE-555-mapped-callee-bridge-readiness-gate.md': '# RE-555 readiness gate\n\n## Progress tracker\n\n- [x] RE-554 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-556 selected; not executed.\n'}
