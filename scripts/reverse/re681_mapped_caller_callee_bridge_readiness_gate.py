"""Produce the fail-closed, metadata-only RE-681 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re680-ghidra-second-window-rank-108-narrow-export-handoff.csv'
PREFIX = 're681-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-680', 'topic': 'ghidra-second-window-rank-108-narrow-export',
    'upstream_handoff': 'RE-679', 'selected_candidate_id': 'eb8e14a9b966',
    'selected_rank': '108',
...
OUTPUT = {
    ...
    'upstream_handoff': 'RE-680', 'selected_candidate_id': 'eb8e14a9b966',
    'selected_rank': '108',
    'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
    'source_symbol_context_count': '4', 'bridge_class': 'mapped-caller-callee-bridge',
    ...
    'next_ticket': 'RE-682', 'next_topic': 'ghidra-second-window-next-candidate-selection',
    'metadata_work_readiness': 'ready', 'code_change_readiness': 'blocked',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re681-mapped-caller-callee-bridge-readiness-gate.md': '# RE-681 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-681-mapped-caller-callee-bridge-readiness-gate.md': '# RE-681 readiness gate\n\n## Progress tracker\n\n- [x] RE-680 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-682 selected; not executed.\n',
    }
