"""Produce the fail-closed, metadata-only RE-563 rank-69 narrow export."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re562-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're563-ghidra-second-window-rank-69-narrow-export'
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re563-ghidra-second-window-rank-69-narrow-export.md': '# RE-563 rank-69 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-563-ghidra-second-window-rank-69-narrow-export.md': '# RE-563 rank-69 narrow export\n\n## Progress tracker\n\n- [x] RE-562 handoff validated.\n- [x] Rank-69 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-564 selected; not executed.\n',
    }
