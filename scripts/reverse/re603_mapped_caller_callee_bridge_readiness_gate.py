"""Produce the fail-closed, metadata-only RE-603 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re602-ghidra-second-window-rank-82-narrow-export-handoff.csv'
PREFIX = 're603-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-602', 'topic': 'ghidra-second-window-rank-82-narrow-export',
    'upstream_handoff': 'RE-601', 'selected_candidate_id': '8d8c7aec748e',
    'selected_rank': '82', 'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
...
def build(repo):
    ...
    row = dict(
        ...
        selected_candidate_id='8d8c7aec748e', selected_rank='82',
        ...
        next_ticket='RE-604', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re603-mapped-caller-callee-bridge-readiness-gate.md': '# RE-603 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-603-mapped-caller-callee-bridge-readiness-gate.md': '# RE-603 readiness gate\n\n## Progress tracker\n\n- [x] RE-602 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-604 selected; not executed.\n',
    }
