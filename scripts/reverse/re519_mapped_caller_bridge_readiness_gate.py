"""Fail-closed metadata-only readiness gate for RE-519."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re518-ghidra-second-window-rank-54-narrow-export-handoff.csv'
PREFIX = 're519-mapped-caller-bridge-readiness-gate'
...
def build(repo):
    ...
    expected = {
        'story_id': 'RE-518',
        'topic': 'ghidra-second-window-rank-54-narrow-export',
        'upstream_handoff': 'RE-517',
        'selected_candidate_id': '65e0849a91c0',
        'selected_rank': '54',
        'selected_subcluster': 'mapped-caller-bridge-readiness-gate',
        'source_symbol_context_count': '7',
        ...
        'stop_condition': 'narrow rank-54 export requires readiness gate before proof-domain selection',
    }
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re519-mapped-caller-bridge-readiness-gate.md': '# RE-519 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-519-mapped-caller-bridge-readiness-gate.md': '# RE-519 readiness gate\n\n## Progress tracker\n\n- [x] RE-518 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-520 selected; not executed.\n',
    }
