...
def build(repo):
 ...
 return {'latest_ticket':f'RE-{n}','next_ticket':last.get('next_ticket','TBD'),'next_topic':last.get('next_topic',''),'recent_ticket_count':len(recent),'rows':recent}
