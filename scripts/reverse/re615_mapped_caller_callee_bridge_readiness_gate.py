"""Produce the fail-closed, metadata-only RE-615 readiness gate."""
import csv
import sys
...
from scripts.reverse import re612_mapped_caller_callee_bridge_readiness_gate as base

BAD, UPFIELDS, FIELDS = base.BAD, base.UPFIELDS, base.FIELDS
UPSTREAM = 'docs/reverse/generated/re614-ghidra-second-window-rank-86-narrow-export-handoff.csv'
PREFIX = 're615-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-614', 'topic': 'ghidra-second-window-rank-86-narrow-export',
    'upstream_handoff': 'RE-613', 'selected_candidate_id': '4fc5988c65ba',
    'selected_rank': '86', 'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-615',
    'next_topic': 'mapped-caller-callee-bridge-readiness-gate', 'metadata_work_readiness': 'ready',
    'code_change_readiness': 'blocked',
    'stop_condition': 'narrow rank-86 export requires readiness gate before proof-domain selection',
}
...
def build(repo):
    ...
    row = dict(
        story_id='RE-615', topic='mapped-caller-callee-bridge-readiness-gate', upstream_handoff='RE-614',
        selected_candidate_id='4fc5988c65ba', selected_rank='86',
        ...
        next_ticket='RE-616', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re615-mapped-caller-callee-bridge-readiness-gate.md': '# RE-615 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-615-mapped-caller-callee-bridge-readiness-gate.md': '# RE-615 readiness gate\n\n## Progress tracker\n\n- [x] RE-614 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-616 selected; not executed.\n',
    }
