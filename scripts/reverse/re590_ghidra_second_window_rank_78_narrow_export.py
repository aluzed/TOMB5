"""Produce the fail-closed, metadata-only RE-590 rank-78 narrow export."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re589-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're590-ghidra-second-window-rank-78-narrow-export'
UPFIELDS = (
...
EXPECTED = {
    'story_id': 'RE-589', 'topic': 'ghidra-second-window-next-candidate-selection',
    'upstream_handoff': 'RE-588', 'closed_candidate_id': '0e8763dda0df',
    'selected_rank': '78', 'selected_candidate_id': '7075d77c2691',
    ...
    'next_ticket': 'RE-590', 'next_topic': 'ghidra-second-window-rank-78-narrow-export',
...
def build(repo):
    ...
    row = dict(
        ...
        upstream_handoff='RE-589', selected_candidate_id='7075d77c2691', selected_rank='78',
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re590-ghidra-second-window-rank-78-narrow-export.md': '# RE-590 rank-78 narrow export\n\nThe selected candidate is filtered metadata only; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-590-ghidra-second-window-rank-78-narrow-export.md': '# RE-590 rank-78 narrow export\n\n## Progress tracker\n\n- [x] RE-589 handoff validated.\n- [x] Rank-78 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Production and code work remain blocked.\n- [x] RE-591 selected; not executed.\n',
    }
