"""Fail-closed metadata-only readiness gate for RE-528."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re527-ghidra-second-window-rank-57-narrow-export-handoff.csv'
PREFIX = 're528-mapped-callee-bridge-readiness-gate'
...
def build(repo):
    ...
    expected = {
        'story_id': 'RE-527',
        'topic': 'ghidra-second-window-rank-57-narrow-export',
        'upstream_handoff': 'RE-526',
        'selected_candidate_id': '326ddce9c64d',
        'selected_rank': '57',
        ...
        'stop_condition': 'narrow rank-57 export requires readiness gate before proof-domain selection',
    }
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re528-mapped-callee-bridge-readiness-gate.md': '# RE-528 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-528-mapped-callee-bridge-readiness-gate.md': '# RE-528 readiness gate\n\n## Progress tracker\n\n- [x] RE-527 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-529 selected; not executed.\n',
    }
