"""Produce the fail-closed, metadata-only RE-494 rank-46 narrow export."""
import csv
...
UPSTREAM='docs/reverse/generated/re493-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX='re494-ghidra-second-window-rank-46-narrow-export'
...
TICKET='RE-494';TOPIC='ghidra-second-window-rank-46-narrow-export';NEXT='RE-495';NEXT_TOPIC='mapped-caller-callee-bridge-readiness-gate';CANDIDATE='8ac39f9a6a85';RANK='46';BRIDGE='mapped-caller-callee-bridge';CONTEXTS='5';STOP='narrow rank-46 export requires readiness gate before proof-domain selection'
...
def write(result,repo):
    ...
    for suffix in ('contexts','summary','handoff'):
        ...
        paths.append(path)
    docs={repo/'docs/reverse/functions/re494-ghidra-second-window-rank-46-narrow-export.md':'# RE-494 rank-46 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n',repo/'docs/stories/RE-494-ghidra-second-window-rank-46-narrow-export.md':'# RE-494 rank-46 narrow export\n\n## Progress tracker\n\n- [x] RE-493 handoff validated.\n- [x] Rank-46 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-495 selected; not executed.\n'}
