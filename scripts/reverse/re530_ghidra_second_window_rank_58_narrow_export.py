"""Produce the fail-closed, metadata-only RE-530 rank-58 narrow export."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re529-ghidra-second-window-next-candidate-selection-handoff.csv'
PREFIX = 're530-ghidra-second-window-rank-58-narrow-export'
...
def build(repo):
    ...
    upstream = rows[0]
    expected = {
        'story_id': 'RE-529', 'topic': 'ghidra-second-window-next-candidate-selection',
        'upstream_handoff': 'RE-528', 'closed_candidate_id': '326ddce9c64d',
        'selected_rank': '58', 'selected_candidate_id': '8671e20f3685',
        'selected_bridge_class': 'mapped-callee-bridge', 'source_symbol_context_count': '6',
        ...
        'next_ticket': 'RE-530', 'next_topic': 'ghidra-second-window-rank-58-narrow-export',
...
def write(row, repo):
    ...
    for suffix in ('contexts', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {repo / 'docs/reverse/functions/re530-ghidra-second-window-rank-58-narrow-export.md': '# RE-530 rank-58 narrow export\n\nThe selected candidate is filtered metadata only; source and code work remain blocked.\n', repo / 'docs/stories/RE-530-ghidra-second-window-rank-58-narrow-export.md': '# RE-530 rank-58 narrow export\n\n## Progress tracker\n\n- [x] RE-529 handoff validated.\n- [x] Rank-58 context narrowed.\n- [x] Filtered metadata-only safety retained.\n- [x] Source and code work remain blocked.\n- [x] RE-531 selected; not executed.\n'}
