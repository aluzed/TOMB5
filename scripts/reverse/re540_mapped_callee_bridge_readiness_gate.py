"""Fail-closed metadata-only readiness gate for RE-540."""
import csv
...
UPSTREAM='docs/reverse/generated/re539-ghidra-second-window-rank-61-narrow-export-handoff.csv';PREFIX='re540-mapped-callee-bridge-readiness-gate'
...
def write(row,repo):
 ...
 for suffix in ('gate','summary','handoff'):
  ...
  outputs.append(path)
 documents={repo/'docs/reverse/functions/re540-mapped-callee-bridge-readiness-gate.md':'# RE-540 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',repo/'docs/stories/RE-540-mapped-callee-bridge-readiness-gate.md':'# RE-540 readiness gate\n\n## Progress tracker\n\n- [x] RE-539 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-541 selected; not executed.\n'}
