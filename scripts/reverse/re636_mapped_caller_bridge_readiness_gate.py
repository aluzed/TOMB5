"""Produce the fail-closed, metadata-only RE-636 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re635-ghidra-second-window-rank-93-narrow-export-handoff.csv'
PREFIX = 're636-mapped-caller-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-635', 'topic': 'ghidra-second-window-rank-93-narrow-export',
    'upstream_handoff': 'RE-634', 'selected_candidate_id': 'd0bf1556870a',
    'selected_rank': '93', 'selected_subcluster': 'mapped-caller-bridge-readiness-gate',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re636-mapped-caller-bridge-readiness-gate.md': '# RE-636 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-636-mapped-caller-bridge-readiness-gate.md': '# RE-636 readiness gate\n\n## Progress tracker\n\n- [x] RE-635 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-637 selected; not executed.\n',
    }
