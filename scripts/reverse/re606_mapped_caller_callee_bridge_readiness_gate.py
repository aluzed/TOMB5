"""Produce the fail-closed, metadata-only RE-606 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re605-ghidra-second-window-rank-83-narrow-export-handoff.csv'
PREFIX = 're606-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-605', 'topic': 'ghidra-second-window-rank-83-narrow-export',
    'upstream_handoff': 'RE-604', 'selected_candidate_id': '586681647d77',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-606',
    'next_topic': 'mapped-caller-callee-bridge-readiness-gate', 'metadata_work_readiness': 'ready',
    'code_change_readiness': 'blocked',
    'stop_condition': 'narrow rank-83 export requires readiness gate before proof-domain selection',
}
...
def build(repo):
    ...
    row = dict(
        story_id='RE-606', topic='mapped-caller-callee-bridge-readiness-gate', upstream_handoff='RE-605',
        selected_candidate_id='586681647d77', selected_rank='83',
        ...
        next_ticket='RE-607', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re606-mapped-caller-callee-bridge-readiness-gate.md': '# RE-606 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-606-mapped-caller-callee-bridge-readiness-gate.md': '# RE-606 readiness gate\n\n## Progress tracker\n\n- [x] RE-605 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-607 selected; not executed.\n',
    }
