"""Produce the fail-closed, metadata-only RE-627 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re626-ghidra-second-window-rank-90-narrow-export-handoff.csv'
PREFIX = 're627-mapped-caller-callee-bridge-readiness-gate'
EXPECTED = {
    'story_id': 'RE-626', 'topic': 'ghidra-second-window-rank-90-narrow-export',
    'upstream_handoff': 'RE-625', 'selected_candidate_id': 'a4b0386cc63b',
    'selected_rank': '90', 'selected_subcluster': 'mapped-caller-callee-bridge-readiness-gate',
...
def build(repo):
    ...
    row = dict(
        story_id='RE-627', topic='mapped-caller-callee-bridge-readiness-gate', upstream_handoff='RE-626',
        selected_candidate_id='a4b0386cc63b', selected_rank='90',
        ...
        next_ticket='RE-628', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re627-mapped-caller-callee-bridge-readiness-gate.md': '# RE-627 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-627-mapped-caller-callee-bridge-readiness-gate.md': '# RE-627 readiness gate\n\n## Progress tracker\n\n- [x] RE-626 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-628 selected; not executed.\n',
    }
