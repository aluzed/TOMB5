"""Fail-closed metadata-only readiness gate for RE-570."""
import csv
...
UPSTREAM = 'docs/reverse/generated/re569-ghidra-second-window-rank-71-narrow-export-handoff.csv'
PREFIX = 're570-mapped-caller-callee-bridge-readiness-gate'
...
def build(repo):
    ...
    row = dict(
        story_id='RE-570', topic='mapped-caller-callee-bridge-readiness-gate', upstream_handoff='RE-569',
        selected_candidate_id='4ad3d6e2b6cd', selected_rank='71',
        selected_subcluster='mapped-caller-callee-bridge-readiness-gate', source_symbol_context_count='6',
        ...
        next_ticket='RE-571', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re570-mapped-caller-callee-bridge-readiness-gate.md': '# RE-570 readiness gate\n\nFiltered metadata-only decision; source and code work remain blocked.\n',
        repo / 'docs/stories/RE-570-mapped-caller-callee-bridge-readiness-gate.md': '# RE-570 readiness gate\n\n## Progress tracker\n\n- [x] RE-569 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Source and code work remain blocked.\n- [x] RE-571 selected; not executed.\n',
    }
