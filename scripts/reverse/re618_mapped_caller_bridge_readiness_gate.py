"""Produce the fail-closed, metadata-only RE-618 readiness gate."""
import csv
import sys
...
UPSTREAM = 'docs/reverse/generated/re617-ghidra-second-window-rank-87-narrow-export-handoff.csv'
PREFIX = 're618-mapped-caller-bridge-readiness-gate'
UPFIELDS = (
...
EXPECTED = {
    'story_id': 'RE-617', 'topic': 'ghidra-second-window-rank-87-narrow-export',
    'upstream_handoff': 'RE-616', 'selected_candidate_id': 'b90186552003', 'selected_rank': '87',
    ...
    'selected_domain': 'none', 'selected_pivot': 'none', 'next_ticket': 'RE-618',
    'next_topic': 'mapped-caller-bridge-readiness-gate', 'metadata_work_readiness': 'ready',
    'code_change_readiness': 'blocked',
    'stop_condition': 'narrow rank-87 export requires readiness gate before proof-domain selection',
}
...
def build(repo):
    ...
    row = dict(
        story_id='RE-618', topic='mapped-caller-bridge-readiness-gate', upstream_handoff='RE-617',
        selected_candidate_id='b90186552003', selected_rank='87',
        ...
        next_ticket='RE-619', next_topic='ghidra-second-window-next-candidate-selection',
...
def write(row, repo):
    ...
    for suffix in ('gate', 'summary', 'handoff'):
        ...
        outputs.append(path)
    documents = {
        repo / 'docs/reverse/functions/re618-mapped-caller-bridge-readiness-gate.md': '# RE-618 readiness gate\n\nFiltered metadata-only decision; production and code work remain blocked.\n',
        repo / 'docs/stories/RE-618-mapped-caller-bridge-readiness-gate.md': '# RE-618 readiness gate\n\n## Progress tracker\n\n- [x] RE-617 handoff validated.\n- [x] Filtered metadata decision recorded.\n- [x] Safety guard retained.\n- [x] Production and code work remain blocked.\n- [x] RE-619 selected; not executed.\n',
    }
