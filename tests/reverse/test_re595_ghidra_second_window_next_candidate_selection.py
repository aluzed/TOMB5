...
def test_re595_candidate_selection_is_metadata_only(tmp_path):
    from scripts.reverse import re595_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-595', '6ba32f9cc1f5', '80', 'ed0d5e683912', 'mapped-caller-bridge', 'RE-596', 'blocked')
...
def test_re595_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re595_ghidra_second_window_next_candidate_selection as module
...
def test_re595_rejects_upstream_schema_drift(tmp_path):
    from scripts.reverse import re595_ghidra_second_window_next_candidate_selection as module
