...
def test_re628_selects_rank_91_metadata_only_candidate(tmp_path):
    from scripts.reverse import re628_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-628', 'a4b0386cc63b', '91', 'a9050d9119e9', 'mapped-caller-callee-bridge', 'RE-629', 'blocked')
...
def test_re628_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re628_ghidra_second_window_next_candidate_selection as module
...
def test_re628_rejects_ranked_candidate_drift(monkeypatch):
    from scripts.reverse import re628_ghidra_second_window_next_candidate_selection as module
...
def test_re628_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re628_ghidra_second_window_next_candidate_selection as module
