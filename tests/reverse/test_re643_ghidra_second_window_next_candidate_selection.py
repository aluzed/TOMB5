...
def test_re643_selects_rank_96_metadata_only_candidate(tmp_path):
    from scripts.reverse import re643_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-643', '96429b1f52ed', '96', '7129784944ab', 'mapped-caller-bridge', 'RE-644', 'blocked')
...
def test_re643_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re643_ghidra_second_window_next_candidate_selection as module
...
def test_re643_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re643_ghidra_second_window_next_candidate_selection as module
