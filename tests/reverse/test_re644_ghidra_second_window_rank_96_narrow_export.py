...
def test_re644_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re644_ghidra_second_window_rank_96_narrow_export as module
    ...
    ) == ('RE-644', '96', '7129784944ab', 'mapped-caller-bridge', 'RE-645', 'blocked')
...
def test_re644_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re644_ghidra_second_window_rank_96_narrow_export as module
...
def test_re644_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re644_ghidra_second_window_rank_96_narrow_export as module
