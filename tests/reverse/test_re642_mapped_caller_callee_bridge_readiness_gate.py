...
def test_re642_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re642_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-642', '96429b1f52ed', '95', '0', 'RE-643', 'blocked')
...
def test_re642_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re642_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re642_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re642_mapped_caller_callee_bridge_readiness_gate as module
