...
def test_re598_candidate_selection_is_metadata_only(tmp_path):
    from scripts.reverse import re598_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-598', 'ed0d5e683912', '81', '017bb509d513', 'mapped-caller-bridge', 'RE-599', 'blocked')
...
def test_re598_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re598_ghidra_second_window_next_candidate_selection as module
...
def test_re598_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re598_ghidra_second_window_next_candidate_selection as module
