...
def test_re650_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re650_ghidra_second_window_rank_98_narrow_export as module
    ...
    ) == ('RE-650', '98', '0f32795d8e8f', 'mapped-caller-callee-bridge', 'RE-651', 'blocked')
...
def test_re650_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re650_ghidra_second_window_rank_98_narrow_export as module
...
def test_re650_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re650_ghidra_second_window_rank_98_narrow_export as module
