...
def test_re625_selects_rank_90_metadata_only_candidate(tmp_path):
    from scripts.reverse import re625_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-625', '9b740dde01c4', '90', 'a4b0386cc63b', 'mapped-caller-callee-bridge', 'RE-626', 'blocked')
...
def test_re625_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re625_ghidra_second_window_next_candidate_selection as module
...
def test_re625_rejects_ranked_candidate_drift(monkeypatch):
    from scripts.reverse import re625_ghidra_second_window_next_candidate_selection as module
...
def test_re625_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re625_ghidra_second_window_next_candidate_selection as module
