...
def test_re653_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re653_ghidra_second_window_rank_99_narrow_export as module
    ...
    ) == ('RE-653', '99', '93cf174d114a', 'mapped-callee-bridge', 'RE-654', 'blocked')
...
def test_re653_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re653_ghidra_second_window_rank_99_narrow_export as module
...
def test_re653_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re653_ghidra_second_window_rank_99_narrow_export as module
