...
def test_re596_rank_80_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re596_ghidra_second_window_rank_80_narrow_export as module
    ...
    ) == ('RE-596', '80', 'ed0d5e683912', '0', 'RE-597', 'blocked')
...
def test_re596_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re596_ghidra_second_window_rank_80_narrow_export as module
...
def test_re596_rejects_upstream_schema_drift(tmp_path):
    from scripts.reverse import re596_ghidra_second_window_rank_80_narrow_export as module
