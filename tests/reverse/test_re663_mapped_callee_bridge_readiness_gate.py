...
def test_re663_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re663_mapped_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-663', '102', '3de39d58a7ec', 'mapped-callee-bridge', 'RE-664', 'blocked')
...
def test_re663_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re663_mapped_callee_bridge_readiness_gate as module
...
def test_re663_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re663_mapped_callee_bridge_readiness_gate as module
