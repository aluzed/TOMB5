...
def test_re615_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re615_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-615', '4fc5988c65ba', '86', '0', 'RE-616', 'blocked')
...
def test_re615_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re615_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re615_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re615_mapped_caller_callee_bridge_readiness_gate as module
