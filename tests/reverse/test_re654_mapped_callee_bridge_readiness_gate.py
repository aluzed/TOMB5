...
def test_re654_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re654_mapped_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-654', '99', '93cf174d114a', 'mapped-callee-bridge', 'RE-655', 'blocked')
...
def test_re654_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re654_mapped_callee_bridge_readiness_gate as module
...
def test_re654_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re654_mapped_callee_bridge_readiness_gate as module
