...
def test_re599_rank_81_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re599_ghidra_second_window_rank_81_narrow_export as module
    ...
    ) == ('RE-599', '81', '017bb509d513', '0', 'RE-600', 'blocked')
...
def test_re599_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re599_ghidra_second_window_rank_81_narrow_export as module
...
def test_re599_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re599_ghidra_second_window_rank_81_narrow_export as module
