...
def test_re638_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re638_ghidra_second_window_rank_94_narrow_export as module
    ...
    ) == ('RE-638', '94', 'a4687ba1ab10', 'mapped-caller-callee-bridge', 'RE-639', 'blocked')
...
def test_re638_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re638_ghidra_second_window_rank_94_narrow_export as module
...
def test_re638_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re638_ghidra_second_window_rank_94_narrow_export as module
