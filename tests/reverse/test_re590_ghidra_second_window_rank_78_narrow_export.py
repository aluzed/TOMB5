...
def test_re590_rank_78_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re590_ghidra_second_window_rank_78_narrow_export as module
    ...
    ) == ('RE-590', '78', '7075d77c2691', '0', 'RE-591', 'blocked')
...
def test_re590_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re590_ghidra_second_window_rank_78_narrow_export as module
...
def test_re590_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re590_ghidra_second_window_rank_78_narrow_export as module
