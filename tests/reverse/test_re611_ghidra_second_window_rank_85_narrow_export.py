...
def test_re611_metadata_only(tmp_path):
    from scripts.reverse import re611_ghidra_second_window_rank_85_narrow_export as module
    ...
    ) == ('RE-611', '85', '259084955c25', 'mapped-caller-callee-bridge', 'RE-612', 'blocked')
...
def test_re611_rejects_upstream_drift(tmp_path, field):
    from scripts.reverse import re611_ghidra_second_window_rank_85_narrow_export as module
...
def test_re611_rejects_schema_and_row_count(tmp_path):
    from scripts.reverse import re611_ghidra_second_window_rank_85_narrow_export as module
