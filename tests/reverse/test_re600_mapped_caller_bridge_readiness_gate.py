...
def test_re600_mapped_caller_bridge_readiness_gate_is_metadata_only(tmp_path):
    from scripts.reverse import re600_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-600', '017bb509d513', '81', '0', 'RE-601', 'blocked')
...
def test_re600_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re600_mapped_caller_bridge_readiness_gate as module
...
def test_re600_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re600_mapped_caller_bridge_readiness_gate as module
