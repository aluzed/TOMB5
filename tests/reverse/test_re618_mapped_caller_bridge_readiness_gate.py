...
def test_re618_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re618_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-618', 'b90186552003', '87', '0', 'RE-619', 'blocked')
...
def test_re618_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re618_mapped_caller_bridge_readiness_gate as module
...
def test_re618_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re618_mapped_caller_bridge_readiness_gate as module
