...
def test_re631_selects_rank_92_metadata_only_candidate(tmp_path):
    from scripts.reverse import re631_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-631', 'a9050d9119e9', '92', 'fdae952cff84', 'mapped-caller-callee-bridge', 'RE-632', 'blocked')
...
def test_re631_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re631_ghidra_second_window_next_candidate_selection as module
...
def test_re631_rejects_ranked_candidate_drift(monkeypatch):
    from scripts.reverse import re631_ghidra_second_window_next_candidate_selection as module
...
def test_re631_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re631_ghidra_second_window_next_candidate_selection as module
