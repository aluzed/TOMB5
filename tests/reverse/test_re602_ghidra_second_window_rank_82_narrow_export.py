...
def test_re602_rank_82_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re602_ghidra_second_window_rank_82_narrow_export as module
    ...
    ) == ('RE-602', '82', '8d8c7aec748e', '0', 'RE-603', 'blocked')
...
def test_re602_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re602_ghidra_second_window_rank_82_narrow_export as module
...
def test_re602_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re602_ghidra_second_window_rank_82_narrow_export as module
