...
def test_re647_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re647_ghidra_second_window_rank_97_narrow_export as module
    ...
    ) == ('RE-647', '97', '9453fad2974f', 'mapped-caller-callee-bridge', 'RE-648', 'blocked')
...
def test_re647_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re647_ghidra_second_window_rank_97_narrow_export as module
...
def test_re647_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re647_ghidra_second_window_rank_97_narrow_export as module
