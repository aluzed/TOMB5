...
def test_re641_metadata_only_narrow_export(tmp_path):
    from scripts.reverse import re641_ghidra_second_window_rank_95_narrow_export as module
    ...
    ) == ('RE-641', '95', '96429b1f52ed', 'mapped-caller-callee-bridge', 'RE-642', 'blocked')
...
def test_re641_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re641_ghidra_second_window_rank_95_narrow_export as module
...
def test_re641_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re641_ghidra_second_window_rank_95_narrow_export as module
