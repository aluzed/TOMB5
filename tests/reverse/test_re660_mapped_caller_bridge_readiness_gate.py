...
def test_re660_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re660_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-660', '101', '6b59cdbcb8e4', 'mapped-caller-bridge', 'RE-661', 'blocked')
...
def test_re660_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re660_mapped_caller_bridge_readiness_gate as module
...
def test_re660_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re660_mapped_caller_bridge_readiness_gate as module
