...
def test_re640_selects_rank_95_metadata_only_candidate(tmp_path):
    from scripts.reverse import re640_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-640', 'a4687ba1ab10', '95', '96429b1f52ed', 'mapped-caller-callee-bridge', 'RE-641', 'blocked')
...
def test_re640_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re640_ghidra_second_window_next_candidate_selection as module
...
def test_re640_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re640_ghidra_second_window_next_candidate_selection as module
