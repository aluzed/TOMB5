...
def test_re666_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re666_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-666', '103', 'e95e1266523c', 'mapped-caller-callee-bridge', 'RE-667', 'blocked')
...
def test_re666_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re666_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re666_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re666_mapped_caller_callee_bridge_readiness_gate as module
