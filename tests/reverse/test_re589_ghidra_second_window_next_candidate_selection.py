...
def test_re589_candidate_selection_is_metadata_only(tmp_path):
    from scripts.reverse import re589_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-589', '0e8763dda0df', '78', '7075d77c2691', 'mapped-caller-bridge', 'RE-590', 'blocked')
...
def test_re589_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re589_ghidra_second_window_next_candidate_selection as module
...
def test_re589_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re589_ghidra_second_window_next_candidate_selection as module
