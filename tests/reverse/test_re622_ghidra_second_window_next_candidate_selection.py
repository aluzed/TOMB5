...
def test_re622_selects_rank_89_metadata_only_candidate(tmp_path):
    from scripts.reverse import re622_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-622', '702e56cbdb0b', '89', '9b740dde01c4', 'mapped-caller-callee-bridge', 'RE-623', 'blocked')
...
def test_re622_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re622_ghidra_second_window_next_candidate_selection as module
...
def test_re622_rejects_ranked_candidate_drift(monkeypatch):
    from scripts.reverse import re622_ghidra_second_window_next_candidate_selection as module
...
def test_re622_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re622_ghidra_second_window_next_candidate_selection as module
