...
def test_re588_readiness_gate_is_metadata_only(tmp_path):
    from scripts.reverse import re588_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-588', '77', '0e8763dda0df', '0', 'RE-589', 'blocked')
...
def test_re588_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re588_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re588_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re588_mapped_caller_callee_bridge_readiness_gate as module
