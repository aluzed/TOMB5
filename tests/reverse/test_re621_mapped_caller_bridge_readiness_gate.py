...
def test_re621_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re621_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-621', '702e56cbdb0b', '88', '0', 'RE-622', 'blocked')
...
def test_re621_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re621_mapped_caller_bridge_readiness_gate as module
...
def test_re621_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re621_mapped_caller_bridge_readiness_gate as module
