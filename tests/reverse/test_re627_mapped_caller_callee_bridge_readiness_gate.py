...
def test_re627_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re627_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-627', 'a4b0386cc63b', '90', '0', 'RE-628', 'blocked')
...
def test_re627_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re627_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re627_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re627_mapped_caller_callee_bridge_readiness_gate as module
