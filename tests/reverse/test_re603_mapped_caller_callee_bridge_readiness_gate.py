...
def test_re603_mapped_caller_callee_bridge_readiness_gate_is_metadata_only(tmp_path):
    from scripts.reverse import re603_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-603', '8d8c7aec748e', '82', '0', 'RE-604', 'blocked')
...
def test_re603_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re603_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re603_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re603_mapped_caller_callee_bridge_readiness_gate as module
