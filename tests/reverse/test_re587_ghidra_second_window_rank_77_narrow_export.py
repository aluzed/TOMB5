...
def test_re587_rank_77_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re587_ghidra_second_window_rank_77_narrow_export as module
    ...
    ) == ('RE-587', '77', '0e8763dda0df', '0', 'RE-588', 'blocked')
