...
def test_re637_selects_rank_94_metadata_only_candidate(tmp_path):
    from scripts.reverse import re637_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-637', 'd0bf1556870a', '94', 'a4687ba1ab10', 'mapped-caller-callee-bridge', 'RE-638', 'blocked')
...
def test_re637_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re637_ghidra_second_window_next_candidate_selection as module
...
def test_re637_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re637_ghidra_second_window_next_candidate_selection as module
