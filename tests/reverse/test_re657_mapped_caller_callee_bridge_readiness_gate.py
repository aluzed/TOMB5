...
def test_re657_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re657_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-657', '100', '3f3ca77b4b8e', 'mapped-caller-callee-bridge', 'RE-658', 'blocked')
...
def test_re657_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re657_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re657_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re657_mapped_caller_callee_bridge_readiness_gate as module
