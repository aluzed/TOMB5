...
def test_re612_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re612_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-612', '259084955c25', '85', '0', 'RE-613', 'blocked')
...
def test_re612_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re612_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re612_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re612_mapped_caller_callee_bridge_readiness_gate as module
