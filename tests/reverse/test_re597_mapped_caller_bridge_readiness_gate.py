...
def test_re597_mapped_caller_bridge_readiness_gate_is_metadata_only(tmp_path):
    from scripts.reverse import re597_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-597', 'ed0d5e683912', '80', '0', 'RE-598', 'blocked')
...
def test_re597_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re597_mapped_caller_bridge_readiness_gate as module
...
def test_re597_rejects_upstream_schema_drift(tmp_path):
    from scripts.reverse import re597_mapped_caller_bridge_readiness_gate as module
