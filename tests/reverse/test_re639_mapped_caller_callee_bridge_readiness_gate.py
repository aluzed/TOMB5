...
def test_re639_metadata_only_readiness_gate(tmp_path):
    from scripts.reverse import re639_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-639', 'a4687ba1ab10', '94', '0', 'RE-640', 'blocked')
...
def test_re639_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re639_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re639_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re639_mapped_caller_callee_bridge_readiness_gate as module
