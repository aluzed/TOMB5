...
def test_re591_readiness_gate_remains_metadata_only(tmp_path):
    from scripts.reverse import re591_mapped_caller_bridge_readiness_gate as module
    ...
    ) == ('RE-591', '78', '7075d77c2691', '0', 'RE-592', 'blocked')
...
def test_re591_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re591_mapped_caller_bridge_readiness_gate as module
...
def test_re591_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re591_mapped_caller_bridge_readiness_gate as module
