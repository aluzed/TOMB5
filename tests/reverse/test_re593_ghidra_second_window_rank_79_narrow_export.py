...
def test_re593_rank_79_narrow_export_is_metadata_only(tmp_path):
    from scripts.reverse import re593_ghidra_second_window_rank_79_narrow_export as module
    ...
    ) == ('RE-593', '79', '6ba32f9cc1f5', '0', 'RE-594', 'blocked')
...
def test_re593_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re593_ghidra_second_window_rank_79_narrow_export as module
...
def test_re593_rejects_upstream_schema_drift(tmp_path):
    from scripts.reverse import re593_ghidra_second_window_rank_79_narrow_export as module
