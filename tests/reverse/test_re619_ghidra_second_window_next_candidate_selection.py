...
def test_re619_metadata_only_selection(tmp_path):
    from scripts.reverse import re619_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-619', 'b90186552003', '88', '702e56cbdb0b', 'mapped-caller-bridge', 'RE-620', 'blocked')
...
def test_re619_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re619_ghidra_second_window_next_candidate_selection as module
...
def test_re619_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re619_ghidra_second_window_next_candidate_selection as module
