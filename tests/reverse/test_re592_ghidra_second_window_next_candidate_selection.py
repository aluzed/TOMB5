...
def test_re592_candidate_selection_is_metadata_only(tmp_path):
    from scripts.reverse import re592_ghidra_second_window_next_candidate_selection as module
    ...
    ) == ('RE-592', '7075d77c2691', '79', '6ba32f9cc1f5', 'mapped-caller-bridge', 'RE-593', 'blocked')
...
def test_re592_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re592_ghidra_second_window_next_candidate_selection as module
...
def test_re592_rejects_upstream_schema_drift(tmp_path):
    from scripts.reverse import re592_ghidra_second_window_next_candidate_selection as module
