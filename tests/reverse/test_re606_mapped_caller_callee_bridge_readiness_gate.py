...
def test_re606_mapped_caller_callee_bridge_readiness_gate_is_metadata_only(tmp_path):
    from scripts.reverse import re606_mapped_caller_callee_bridge_readiness_gate as module
    ...
    ) == ('RE-606', '586681647d77', '83', '0', 'RE-607', 'blocked')
...
def test_re606_rejects_each_upstream_handoff_field_drift(tmp_path, field):
    from scripts.reverse import re606_mapped_caller_callee_bridge_readiness_gate as module
...
def test_re606_rejects_upstream_schema_and_row_count_drift(tmp_path):
    from scripts.reverse import re606_mapped_caller_callee_bridge_readiness_gate as module
